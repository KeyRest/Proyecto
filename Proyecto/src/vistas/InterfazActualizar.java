 ...
 */
public class InterfazActualizar extends javax.swing.JDialog {

    /**
     * Creates new form InterfazMostrar
     */
    public InterfazActualizar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazActualizar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InterfazActualizar dialog = new InterfazActualizar(new javax.swing.JFrame(), true);
